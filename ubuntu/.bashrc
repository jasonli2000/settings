...
export vistadir="/home/softhat/VistA/"
export gtmgbldir="${vistadir}/database"
export gtmroutines="${vistadir}/database/routines ${gtm_dist} /home/softhat/src/M-Tools/CodeFormatter"
export EDITOR=`which gvim`
alias gtm="${gtm_dist}/mumps -direct"
alias mupip="${gtm_dist}/mupip"
alias GDE="${gtm_dist}/mumps -r GDE"
alias LKE="${gtm_dist}/mumps -r LKE"
alias rundown='/opt/gtm/mupip rundown -r "*"'
#setting related to the IBUS
